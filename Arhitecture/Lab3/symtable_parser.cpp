...
std::string SymtableParser::GetBind(int code) {
    switch (code) {
        case 0: return "LOCAL";
...
std::string SymtableParser::GetType(int code) {
    switch (code) {
...
std::string SymtableParser::GetVisibility(int code) {
    switch (code) {
...
std::string SymtableParser::GetId(int code) {
    switch (code) {
        case 0: return "UNDEF";
