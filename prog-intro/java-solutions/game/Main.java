...
public class Main {
    ...
    private static void choosePlayer(final Scanner scanner, final int m, final int n) {
        System.out.println("Choose first player:");
        System.out.println("1. Human");
        System.out.println("2. Random");
        final int playerType = scanner.nextInt();
        if (playerType == 1) {
    ...
    public static void main(final String[] args) {
        ...
        if (gameMode == 1) {
            ...
            new Tournament(m, n, k, players, blockedCells, System.out).play();
        }
