...
public final class BinarySearchTest {
    ...
    private static FullBinarySearchTest.Sorted uniI(final IntBinaryOperator op) {
        return uni((k, a) -> k != 0 && (k == a.length || op.applyAsInt(a[k], a[k - 1]) == a[k - 1] && a[k] != a[k - 1]) ? k - 1 : k);
    }

    private static FullBinarySearchTest.Sorted uni(final BiFunction<Integer, int[], Integer> answer) {
        return (tester, a, b) -> {
